...
public class ProjectController implements ProjectApi {
    ...
    @Override
    public ResponseEntity<BaseResponse<AllBaseResponse<ProjectResponse>>> getAllProjects(@Min(value = 0, message = "page number has to be more than or equal to 0") Integer pageNumber, @Min(value = -1, message = "status has to be more than or equal to -1") int status, @Min(value = 0, message = "page size has to be more than or equal to 0") int pageSize, String title, String sortBy, String sortOrder) {
